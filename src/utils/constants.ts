...
export const TWAB_CONTROLLER_SUBGRAPH_URIS = {
  ...
  [CHAIN_ID.sepolia]: `https://api.studio.thegraph.com/query/50959/pt-v5-twab-control-eth-sepolia/v0.0.1`,
};
...
export const PRIZE_POOL_SUBGRAPH_URIS = {
  ...
  [CHAIN_ID.sepolia]: `https://api.studio.thegraph.com/query/50959/pt-v5-prize-pool-eth-sepolia/v0.0.1`,
};
